...
const registerSteps = [
  ...
  },
  {
    ...
    description: "We register the Will on the Abu Dhabi Judicial Department (ADJD) portal.",
  },
  {
    title: "Video Verification",
    description: "You attend a short video call with the judge for final approval.",
  },
  {
...
const Register = () => {
  // Group steps into 2 + 2 + 2 + 1 for grid with center
  const groups = [
  ...
  return (
    <section id="registration">
      ...
      <div className="will-steps-wrapper">
        {groups.map((group, i) => (
          <div
            key={i}
            className="will-step-group"
            style={
              group.length === 1
          ...
          >
            {group.map((step, idx) => (
              <div
                key={idx}
                className={`will-step-card${group.length === 1 ? " will-step-card--last" : ""}`}
              >
      ...
      <section className="financial-section">
        <h2 className="financial-title">Financial Consultation</h2>
        <p className="financial-desc">Your Path to Financial Peace of Mind</p>
        <p>
        ...
        <h3 className="financial-title">Life Insurance: Protecting What Matters Most</h3>
        <p>
        ...
        <h3 className="financial-title">Independent Investment Advisory: Strategic Growth for Your Future</h3>
        <p>
        ...
        <h3 className="financial-title">Estate Planning: Building a Lasting Legacy</h3>
        <p>
